...
class Config(object):
    ...
    def __init__(self, options):
        ...
        # Todo Smita: comment all options..
        self.dataFolder = "" #options.anchorFolder
        
        self.OCCLUSION = False #'occlusion' in options.dataset
        # self.loadAnchorPlanes(options.anchorType)
        self.PREDICT_DEPTH = True
        self.PREDICT_BOUNDARY = False
        self.PREDICT_NORMAL_NP = True #'normal_np' in options.suffix
        
        self.BILINEAR_UPSAMPLING = False#'bilinear' in options.suffix
        self.FITTING_TYPE = 0
        return
